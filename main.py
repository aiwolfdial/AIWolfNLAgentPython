...
if __name__ == "__main__":
    ...
    sock = lib.connection.Server(inifile=inifile, name=inifile.get("agent","name1")) if inifile.getboolean("connection","host_flag") else lib.connection.Client(config_path=config_path)
    sock.connect()
